...
import { FileUploader, type FileUploadData } from "../src/ui/file-uploader";
import { FileType, FILE_TYPE_GROUPS } from "../src/ui/file-uploader/file-utils";
  ...
  parameters: {
    msw: {
      handlers: {
        ...
        upload: http.post("/api/v1/files", async ({ request }) => {
