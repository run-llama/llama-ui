  ...
  workflowTask: [
    ...
    http.post(
      ...
      async ({ params, request }) => {
        console.log("MSW: Intercepted task creation request", {
          params,
          url: request.url,
        });
        ...
        console.log(
          "MSW: Returning task creation response (raw format):",
          response
        );
    ...
    http.get(
      ...
      async (info) => {
        const { task_id: taskId, deployment_name: deploymentName } =
          info.params;
        ...
        const stream = new ReadableStream({
          start(controller) {
            ...
            console.log(
              `MSW: Generating ${eventCount} events for task ${taskId}`
            );
    ...
    http.get("*/deployments/:deployment_name/tasks", async ({ params }) => {
      ...
      console.log(
        "MSW: Intercepted get tasks list request for deployment:",
        deploymentName
      );
