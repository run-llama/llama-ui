...
interface MultipleSelectorProps<Value extends string = string> {
  value?: Option<Value>[];
  ...
  /** async search */
  onSearch?: (value: string) => Promise<Option<Value>[]>;
...
const defaultArray: Option[] = [];

const MultipleSelector = function MultipleSelector({
  ref,
  value,
  onChange,
  placeholder,
  defaultOptions: arrayDefaultOptions = defaultArray,
...
export { MultipleSelector, useDebounce };
