import type { ExtractedFieldMetadataDict, ExtractedFieldMetadata } from "llama-cloud-services/beta/agent";
 ...
 */
export function isExtractedFieldMetadata(value: unknown): value is ExtractedFieldMetadata {
  ...
  if ('extraction_confidence' in obj && typeof obj.extraction_confidence !== 'number') {
    return false;
  }
