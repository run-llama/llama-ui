...
- bf0935e: Load pdf.js runtime assets from the app's own origin instead of unpkg
...
- 03c1fea: Fix extract table citation paths on paginated pages
...
- 6f36152: Dark mode support for business components. Replaced hardcoded palette colors
